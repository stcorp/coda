...
echo.
echo Building CODA-IDL interface with the following settings:
echo.
...
rem Build the CODA-IDL interface visual studio project
vcbuild /nologo "%CODA_SOURCE_DIR%\windows\codaidl.vcproj" "%CONFIG%"
if %errorlevel% neq 0 exit /b %errorlevel%
